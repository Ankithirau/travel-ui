...
<div class="navbar-container d-flex content">
    ...
    <ul class="nav navbar-nav align-items-center ml-auto">
        ...
        if (Auth::user()->type=='Operator') {
          $notification = App\Models\Bus_request::select('bus_request.*', 'products.name as event_name','products.image as event_image')
            ->join('products', 'bus_request.product_id', '=', 'products.id')->where('request_status', 3)
            ->orderBy('id', 'desc')
            ->get();
        ?>
        <li class="nav-item dropdown dropdown-notification mr-25">
            <a class="nav-link" href="javascript:void(0);" data-toggle="dropdown"><i class="ficon"
                ...
                @if (count($notification)>0)
                  <span class="badge badge-pill badge-danger badge-up">{{ count($notification) }}</span>
                @endif
            </a>
            <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                <li class="dropdown-menu-header">
                    <div class="dropdown-header d-flex">
                        ...
                        <div class="badge badge-pill badge-light-primary">{{ count($notification) }} New</div>
                    </div>
                </li>
                @if (count($notification)>0)
                            ...
                            <div class="media d-flex align-items-start">
                                <div class="media-left">
                                    <div class="avatar"><img
                                            src="{{ asset('uploads/event_image/') . '/' . $item->event_image }}"
                                            alt="avatar" width="32" height="32"></div>
                                </div>
                                <div class="media-body">
                                    <p class="media-heading"><span class="font-weight-bolder">{{ $item->event_name }}
                                            🎉</span></p><small class="notification-text text-warning"> Request
                                        Pending.</small>
                                </div>
                            </div>
                        </a>
                ...
                <li class="scrollable-container media-list">
                  <a class="d-flex" href="javascript:void(0)">
                      <div class="media d-flex align-items-start">
                        <small class="text-warning">No Request Found</small>
                      </div>
                  </a>
              </li>
                @endif
                <li class="dropdown-menu-footer">
                    <a class="btn btn-primary btn-block" href="{{route('operator.request')}}">Read
                        all notifications
                    </a>
                </li>
            </ul>
        ...
        <li class="nav-item dropdown dropdown-user">
            ...
            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdown-user">
                <a class="dropdown-item" href="{{ route('users.show', Auth::user()->id) }}">
                    <i class="mr-50" data-feather='settings'></i> Setting
                </a>
