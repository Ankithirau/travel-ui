...
<body topmargin="0" rightmargin="0" bottommargin="0" leftmargin="0" marginwidth="0" marginheight="0" width="100%" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; width: 100%; height: 100%; -webkit-font-smoothing: antialiased; text-size-adjust: 100%; -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; line-height: 100%;
    ...
    max-width: 560px;" class="wrapper">
            ...
            color: #F0F0F0;" class="preheader"> SAVE THIS E-TICKET TO YOUR PHONE OR PRINT. </div>
                            <!-- LOGO -->
                            <!-- Image text color should be opposite to background color. Set your url, image src, alt and title. Alt text should fit the image size. Real image size should be x2. URL format: http://domain.com/?utm_source=&utm_medium=email&utm_content=logo&utm_campaign= -->
                            <!-- <a target="_blank" style="text-decoration: none;" href="https://github.com/konsav/email-templates/">
                                <img border="0" vspace="0" hspace="0" src="#" width="450" height="70" alt="Logo" title="Logo" style="
                                            color: #000000;
    ...
    max-width: 560px;" class="container">
                    ...
                    <tr>
                        <td align="center" valign="top" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; padding-left: 6.25%; padding-right: 6.25%;padding-bottom: 13px; width: 87.5%; font-size: 24px; font-weight: bold; line-height: 130%;
            padding-top: 25px;
            color: #5045E4;
            font-family: sans-serif;" class="header"> <img border="0" vspace="0" hspace="0"
                                src="{{asset('uploads/seo_image/mail.png')}}" width="450" height="70" alt="Logo"
                                title="Logo"
                                style="
                color: #000000;
                font-size: 10px; margin: 0; padding: 0;outline: none; text-decoration: none; -ms-interpolation-mode: bicubic; border: none; display: block;" />
            ...
            padding-top: 5px;
            color: #FFFFFF;
            font-family: sans-serif;background-color: #5045E4;" class="subheader"> SAVE THIS E-TICKET TO YOUR PHONE OR
                            PRINT. </td>
                    </tr>
                    <tr>
                    ...
                    padding-top: 10px;
                    padding-right: 20px;">
                                        <p style="font-size: 17px; font-weight: 400; line-height: 160%; border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0;
                    padding-top: 5px;
                    color: #000000;
                    font-family: sans-serif;" class="paragraph">
                                            <b style="color: #333333;">Laura Benson</b>
                                        </p>
                                    </td>
                                    <!-- LIST ITEM TEXT -->
                    ...
                    color: #000000;
                    font-family: sans-serif;" class="paragraph">
                                            <b style="color: #333333;">Passenger Name:</br>
                                                Laura Benson</b>
                                        </p>
                                    </td>
                                    <!-- LIST ITEM TEXT -->
                    ...
                    color: #000000;
                    font-family: sans-serif;" class="paragraph">
                                        <b style="color: #333333;">Bus to Westlife Pairc Ui Chaoimh
                                            Cork - Nationwide Return - Aug
                                            12th & 13th 2022 (13th August,
                                            Limerick, LIMERICK CITY @
                                            2.30pm (City East Plaza)
                                        </b>
                                    </td>
                                </tr>
                            </table>
                    ...
                    <!-- HERO IMAGE -->
                    <!-- Image text color should be opposite to background color. Set your url, image src, alt and title. Alt text should fit the image size. Real image size should be x2 (wrapper x2). Do not set height for flexible images (including "auto"). URL format: http://domain.com/?utm_source=&utm_medium=email&utm_content=&utm_campaign= -->
                    <tr>
                        <td align="center" valign="top" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0;
            padding-top: 20px;" class="hero">
                            <a target="_blank" style="text-decoration: none;"
                                href="https://github.com/konsav/email-templates/"> <img border="0" vspace="0" hspace="0"
                                    src="{{asset('uploads/seo_image/1655114485.jpg')}}"
            ...
            padding-bottom: 25px;
            color: #000000;
            font-family: sans-serif;" class="paragraph"> Have a&nbsp;question? <a href="mailto:support@ourteam.com"
                                target="_blank"
                                style="color: #127DB3; font-family: sans-serif; font-size: 17px; font-weight: 400; line-height: 160%;">support@travelmaster.com</a>
                        </td>
                    </tr>
                    <!-- End of WRAPPER -->
                </table>
    ...
    max-width: 560px;" class="wrapper">
            ...
            padding-bottom: 20px;
            color: #999999;
            font-family: sans-serif;" class="footer"> This email template was sent to&nbsp;you becouse we&nbsp;want to&nbsp;make the&nbsp;world a&nbsp;better place. You&nbsp;could change your <a href="https://github.com/konsav/email-templates/" target="_blank" style="text-decoration: underline; color: #999999; font-family: sans-serif; font-size: 13px; font-weight: 400; line-height: 150%;">subscription settings</a> anytime. -->
                    <!-- ANALYTICS -->
                    <!-- http://www.google-analytics.com/collect?v=1&tid=&cid=&t=event&ec=email&ea=open&cs=&cm=email&cn= -->
                    <!--  <img width="1" height="1" border="0" vspace="0" hspace="0" style="margin: 0; padding: 0; outline: none; text-decoration: none; -ms-interpolation-mode: bicubic; border: none; display: block;" src="https://raw.githubusercontent.com/konsav/email-templates/master/images/tracker.png" /> </td> -->
                    <!-- </tr> -->
                    <!-- End of WRAPPER -->
                </table>
