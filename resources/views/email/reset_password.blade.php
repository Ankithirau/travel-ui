                                                    ...
                                                    <tr>
                                                        <td align="left"
                                                            ...
                                                            <table role="presentation" border="0" cellpadding="0"
                                                                cellspacing="0"
                                                                style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: auto;margin-top:20px">
                                                                <tbody>
                                                                    <tr>
                                                                        <h1></h1>
                                                                        <p>{{ $pwd_store->email }}</p>
                                                                        ...
                                                                        //     $email = $update->email;
                                                                            ...
                                                                            // $url = config('base_url') . 'password/reset/' . $token . '?email=' . urlencode($user->email);
                                                                            // $url = 'http://localhost:3000/password/reset/' . $token . '/' . $time . '/' . $email;
                                                                            $url = 'http://localhost:3000/password/reset?token=' . $pwd_store->token . '&email=' . urlencode($pwd_store->email);
                                                                            // echo $url;
                                                                        @endphp
                            ...
                            <tr>
                                <td class="content-block"
                                    ...
                                    <span class="apple-link"
                                        style="color: #999999; font-size: 12px; text-align: center;">Travelmaster, 3
                                        Abbey Road, Dublin IR 94102</span>
                            ...
                            <tr>
                                <td class="content-block powered-by"
                                    ...
                                    Powered by <a href="http://htmlemail.io"
                                        style="color: #999999; font-size: 12px; text-align: center; text-decoration: none;">Travelmaster</a>.
                                </td>
                            </tr>
                        </table>
                    </div>
