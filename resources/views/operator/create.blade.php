...
<div class="page-header">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page">Create Operator</li>
  </ol><!-- End breadcrumb -->
  {{-- <div class="ml-auto">
    <div class="input-group">
      <a href="javascript:void(0);" class="btn btn-primary text-white mr-2 btn-sm" data-toggle="modal"
        data-target="#modalPlace" title="Add Place">
        <span>
  ...
  <div class="col-md-12 col-lg-12">
    <div class="card">
      <div class="card-body pt-4">
        <form name="ajax_form" method="post" action="{{route('operator.store')}}" enctype="multipart/form-data"
          novalidate>
          @csrf
          @method('post')
          <div class="row">
