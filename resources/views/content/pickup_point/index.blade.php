...
@section('content')
    ...
    <section class="app-user-list">
        ...
        <div class="card p-1">
            ...
            <div class="card-header border-bottom">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb" style="padding: 0.1rem 0.1rem;">
                        ...
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Pickup Point</a></li>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="custom-control custom-control-success custom-switch">
                                            ...
                                            data-url="{{ route('pickup-point.status', $result->id) }}" />
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                ...
                                                data-title="PickupPoint" data-url="{{ route('pickup-point.edit', $result->id) }}"
                                                data-action="{{ route('pickup-point.update', $result->id) }}">
                                                    <i data-feather="edit-2" class="mr-50"></i>
                                                    <span>Edit</span>
                                                </a>
                                                <a class="dropdown-item deleteRecord" data-url="{{route('pickup-point.destroy', $result->id)}}" href="javascript:void(0);">
            ...
            <div class="modal modal-slide-in new-user-modal fade" id="modalPickupPoint">
                <div class="modal-dialog">
                    <form class="add-new-user modal-content pt-0" name="ajax_form" method="post"
                        action="{{route('pickup-point.store')}}" enctype="multipart/form-data">
                        @csrf
                        @method('post')
                        ...
                        <div class="modal-body flex-grow-1">
                            <div class="form-group">
                                <label class="form-label" for="basic-icon-default-fullname">Pickup Point Name</label>
                                <input type="text" class="form-control dt-full-name" id="basic-icon-default-fullname"
                                    placeholder="Enter Pickup Point Name" name="name" aria-label="John Doe"
                                    aria-describedby="basic-icon-default-fullname2" />
                            </div>
                            <div class="form-group">
                                <label class="form-label" for="basic-icon-default-fullname">County Name</label>
                                <select class="form-control" name="counties_id" id="basicSelect">
