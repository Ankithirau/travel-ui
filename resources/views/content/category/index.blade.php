...
@section('content')
    ...
    <section class="app-user-list">
        ...
        <div class="card p-1">
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-left align-items-center">
                                            <div class="avatar me-1">
                                                @php
                                                    $images = !empty($result->category_image) ? $result->category_image : 'no_images.png';
                                                @endphp
                                                <img src="{{ asset('images/uploads/category_image') . '/' . $images }}"
                                                    alt="Avatar" width="32" height="32">
                                            </div>
                                            <div class="d-flex flex-column">
                                                <span
                                                    class="emp_name text-truncate fw-bold">&nbsp;&nbsp;{{ $result->name }}</span>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item editRecord" href="javascript:void(0);"
                                                    ...
                                                    data-action="{{ route('category.update', $result->id) }}">
                                                    <i data-feather="edit-2" class="mr-50"></i>
                                                    <span>Edit</span>
                                                </a>
                                                <a class="dropdown-item deleteRecord" href="javascript:void(0);"
                                                    data-url="{{ route('category.destroy', $result->id) }}">
            ...
            <div class="modal modal-slide-in new-user-modal fade" id="modalCategory">
                        ...
                        <div class="modal-body flex-grow-1">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control dt-full-name" id="basic-icon-default-fullname"
                                    placeholder="Enter Category Name" name="name" aria-label="John Doe"
                                    aria-describedby="basic-icon-default-fullname2" />
                            </div>
                            <div class="form-group">
                                <label class="form-label" for="basic-icon-default-fullname">Category Image</label>
                                <div class="custom-file">
                                    <input type="file" class="custom-file-input" name="category_image" id="image">
