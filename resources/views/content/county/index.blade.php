...
@section('content')
    ...
    <section class="app-user-list">
        ...
        <div class="card p-1">
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item editRecord" href="javascript:void(0);"
                                                    data-title="County" data-url="{{ route('county.edit', $result->id) }}"
            ...
            <div class="modal modal-slide-in new-user-modal fade" id="modalCounty">
