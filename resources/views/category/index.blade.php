...
<div class="page-header">
  ...
  <div class="ml-auto">
    <div class="input-group">
      <a href="javascript:void(0);" class="btn btn-primary text-white mr-2 btn-sm" data-toggle="modal" data-target="#modalCategory" title="Add State">
        <span>
          ...
          <table id="fileexport-datatable" class="mt-2 table table-bordered key-buttons text-nowrap">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <div class="d-flex">
                    <input type="button" class="btn  btn-warning  editRecord" data-title="Category" data-url="{{route('category.edit', $result->id)}}" data-action="{{route('category.update', $result->id)}}" value="Edit">&nbsp;
                    <input type="button" class="btn  btn-danger  deleteRecord" data-url="{{route('category.destroy', $result->id)}}" value="Delete">
                  </div>
                </td>
              </tr>
              @endforeach
