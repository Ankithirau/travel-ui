...
class SliderController extends Controller
{
    ...
    public function index()
    {
        ...
        $results = Slider::select('id', 'title', 'photo', 'product_id', 'status')->orderBy('id', 'desc')->get();

        return view('content.slider.index', compact('pageConfigs','products', 'results'));
    ...
    public function store(Request $request)
    {
        ...
        $request->validate(
            ...
            [
                ...
                'product_id.required'      => 'Event name is required.',
    ...
    {
        $result =  Slider::select('id', 'title', 'product_id','photo')->find($id);
        if ($result) {
